...
namespace Data.Migrations
{
    ...
    [Migration("20250421100837_AddCompanyTypeProcedures")]
    partial class AddCompanyTypeProcedures
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.CompanyTypeDomainModel", b =>
                {
            ...
            modelBuilder.Entity("Entities.DeveloperDomainModel", b =>
                {
            ...
            modelBuilder.Entity("Entities.OpptypeDomainModel", b =>
                {
                    b.Property<int>("OpptypeID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("OpptypeID"));

                    b.Property<int>("CompanyTypeID")
                        .HasColumnType("int");

                    b.Property<string>("OpptypeName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Entities.SystemAdminDomainModel", b =>
                {
            ...
            modelBuilder.Entity("Entities.TeamLead", b =>
                {
            ...
            modelBuilder.Entity("Entities.OpptypeDomainModel", b =>
                {
                    b.HasOne("Entities.CompanyTypeDomainModel", "CompanyType")
                        .WithMany("Opptypes")
            ...
            modelBuilder.Entity("Entities.SystemAdminDomainModel", b =>
                {
                    b.HasOne("Entities.DeveloperDomainModel", "Developer")
            ...
            modelBuilder.Entity("Entities.TeamMember", b =>
                {
                    b.HasOne("Entities.TeamLead", "TeamLead")
